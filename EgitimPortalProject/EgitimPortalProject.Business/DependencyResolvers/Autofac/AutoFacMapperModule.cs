...
namespace EgitimPortalProject.Business.DependencyResolvers.Autofac
{
    public class AutoFacMapperModule : Module
    {
        ...
        public AutoFacMapperModule(IEnumerable<Assembly> assembliesToScan)
        {
            this.assembliesToScan = assembliesToScan;
        }

        public AutoFacMapperModule(params Assembly[] assembliesToScan) : this((IEnumerable<Assembly>)assembliesToScan)
        {
        }
